...
def version():
    tkinter.messagebox.showinfo(title="Version", message="Release Version 0.1")
...
datasave_label = Label(frame1, text="Press to open last created datasave")
datasave_label.grid(row=17, sticky=E)
script1_label = Label(frame1, text="Print ATReport50.pdf and Summary", fg="green")
script1_label.grid(row=18, sticky=E)
...
open_last_datasave_btn = Button(frame1, text="  Open Datasave folder", command=open_last_datasave, anchor=W)
open_last_datasave_btn.config(height=1, width=22)
open_last_datasave_btn.grid(row=17, column=1)
...
lb_machinetype = Listbox(frame2, width=26, height=9, selectmode=SINGLE)  # create a machine type list box
position = 1
